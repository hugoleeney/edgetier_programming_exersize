...
def insert_data():
    ...
    database.session.add(Chat(created=now - timedelta(minutes=10), customer_name="Julia"))
    database.session.add(Chat(created=now - timedelta(minutes=15), customer_name="Joseph"))
